...
/**
 * Initiates an M-Pesa Express (STK Push) simulation and then queries the status
 * using the CheckoutRequestID.
 *
 * (Optional but recommended) - If you can manually provide the CheckoutRequestID,
 * it's preferable. This setup automatically retrieves and passes it, but server
 * delays can cause test failures.
 *
 * To retrieve the CheckoutRequestID, uncomment the console.log statement below.
 */
